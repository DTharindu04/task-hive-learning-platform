      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex space-x-2">
        ...
        <div className="flex-grow flex items-center relative">
          <input
              ...
              className={`w-full px-4 py-2 pr-10 rounded-lg border-0 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-yellow-500 ${
          ...
          <motion.button
              type="submit"
              className="absolute right-3 text-yellow-500 hover:text-yellow-400 disabled:text-gray-600 cursor-pointer"
            ...
            {isEditing ? (
                <form onSubmit={handleSubmit(handleUpdate)} className="mt-1">
                  <div className="flex flex-col space-y-2">
                    <input
                        type="text"
                        className="w-full text-sm px-3 py-2 rounded-lg border-0 bg-gray-900 text-white focus:ring-2 focus:ring-yellow-500"
                    ...
                    <div className="flex justify-end space-x-2">
                      ...
                      <button
                          type="submit"
                          className="text-xs px-3 py-1 bg-yellow-500 hover:bg-yellow-400 text-black rounded-md cursor-pointer"
                      >
                        Save
                      </button>
                    </div>
                        ...
                        <div className="flex space-x-1 ml-2 mt-0.5">
                          {comment.userId === currentUser?.id && (
                              <motion.button
                                  ...
                                  className="text-xs text-gray-400 hover:text-yellow-400 p-1 rounded-full hover:bg-gray-700 transition-colors cursor-pointer"
